...
def parse_args():
    ...
    parser.add_argument('--train_ratio', nargs='?', default= 0) 
    parser.add_argument('--graphname', nargs='?', default='econ')
    parser.add_argument('--mode', nargs='?', default='perturbed', help="not_perturbed or perturbed") 
    parser.add_argument('--edge_portion', nargs='?', default=0.1,  help="a param for the perturbation case")  
    parser.add_argument('--att_portion', nargs='?', default=0.2,  help="a param for the perturbation case")
...
if __name__ == "__main__":
    ...
    S_mv, S_prime, seed_list1, seed_list2, results, att_score = GradAlign.run_algorithm()
